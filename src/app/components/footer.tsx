      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 mb-6 md:mb-0">
            ...
            <ul>
              <li className="mb-2">
                <Link href="/service1" className="hover:text-gray-300 text-sm">
                  Candid Photography
                </Link>
              </li>
              <li className="mb-2">
                <Link href="/service2" className="hover:text-gray-300 text-sm">
                  Pre-Wedding Photography
                </Link>
              </li>
              <li className="mb-2">
                <Link href="/service3" className="hover:text-gray-300 text-sm">
                  Wedding Videography
                </Link>
              </li>
            </ul>
